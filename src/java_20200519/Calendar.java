...
public class Calendar {
	...
	public void print(int year, int month, int day) {
		...
		String message = null;
		if (dayOfWeek == Calendar.MON) {
			message = "월요일";
		} else if (dayOfWeek == Calendar.TUE) {
			message = "화요일";
		} else if (dayOfWeek == Calendar.WED) {
			message = "수요일";
		} else if (dayOfWeek == Calendar.THU) {
			message = "목요일";
		} else if (dayOfWeek == Calendar.FRI) {
			message = "금요일";
		} else if (dayOfWeek == Calendar.SAT) {
			message = "토요일";
		} else if (dayOfWeek == Calendar.SUN) {
			message = "일요일";
		}
